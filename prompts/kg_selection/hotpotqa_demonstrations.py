...
triple_selection_hotpotqa_examplars = [
    [
        {
            ...
            "answer": "B",
            "cot_answer": "According on the question, the first step is to identify an actor who acted in \"Him\". So the next relevant triple is B.", 
        },
        {
            "question": "Who distributed a movie whose cast includes an actor who acted in \"Him\"?",
            "triples": [
            ...
            "answer": "B",
            "cot_answer": "According to the question and existing triples, we have established that Fionn Whitehead acted in \"Him\". The next step is to find a movie that Fionn Whitehead starred in. So the next relevant triple is B.",
        },
        {
            "question": "Who distributed a movie whose cast includes an actor who acted in \"Him\"?",
            "triples": [
            ...
            "answer": "E",
            "cot_answer":"According to the question and existing triples, we have established that Fionn Whitehead acted in \"Him\" and is part of the cast of \"Dunkirk\". The next step is to find out who distributed \"Dunkirk\". So the next relevant triple is E.",
        },
        {
            "question": "Who distributed a movie whose cast includes an actor who acted in \"Him\"?",
            "triples": [
            ...
            "answer": "A",
            "cot_answer": "According to the question and existing triples, we have established that Fionn Whitehead acted in \"Him\" and is part of the cast of \"Dunkirk\". We also know that \"Dunkirk\" is distributed by Warner Bros. Pictures. This provides a complete reasoning path to answer the question. So the next relevant triple is A.",
        },
    ],
    [
        {
            ...
            "answer": "E",
            "cot_answer": "According to the question, we need the information frequencies of these two magazines. So the next relevant triple is E.", 
        },
        {
            "question": "Which magazine published papers more often; The Wittenburg Door or Sports Collectors Digest?",
            "triples": [
            ...
            "answer": "D",
            "cot_answer": "According to the question and existing triples, we have established that Sports Collectors Digest is a weekly paper. The next step is to find out the publication frequency of The Wittenburg Door. So the next relevant triple is D.", 
        },
        {
            "question": "Which magazine published papers more often; The Wittenburg Door or Sports Collectors Digest?",
            "triples": [
            ...
            "answer": "A",
            "cot_answer":"According to the question and existing triples, we know that Sports Collectors Digest is a weekly paper, and The Wittenburg Door has a publication frequency of bimonthly. This provides a complete reasoning path to answer the question. So the next relevant triple is A.", 
        },
    ],
    [
        {
            ...
            "answer": "C",
            "cot_answer": "According to the question, the first step is to identify the soft drink that ICP traditionally sprays on their audience. So the next relevant triple is C.",
        },
        {
            "question": "Where is the headquarters of the company that produces the soft drink that the ICP traditionally sprays the audience with ?",
            "triples": [
            ...
            "answer": "E",
            "cot_answer": "According to the question and existing triples, we have established that ICP sprays Faygo on their audience. The next step is to find the headquarters of the company that produces Faygo. So the next relevant triple is E.", 
        },
        {
            "question": "Where is the headquarters of the company that produces the soft drink that the ICP traditionally sprays the audience with ?",
            "triples": [
            ...
            "answer": "D",
            "cot_answer": "According to the question and existing triples, we have established that ICP sprays Faygo on their audience and that Faygo is a soft drink company. The next step is to find the headquarters of Faygo. So the next relevant triple is D.",
        },
        {
            "question": "Where is the headquarters of the company that produces the soft drink that the ICP traditionally sprays the audience with ?",
            "triples": [
            ...
            "answer": "A", 
            "cot_answer": "According to the question and existing triples, we have established that the soft drink ICP traditionally sprays the audience with is Faygo, and that Faygo is a soft drink company located in Detroit, Michigan. This provides a complete reasoning path to answer the question. So the next relevant triple is A.", 
        },
    ],
    [
        {
            ...
            "answer": "B",
            "cot_answer": "Accordiing to the question, we first need to identify the university where W.G. Godfrey received his BA and MA degrees. So the next relevant triple is B.", 
        },
        {
            "question": "What  are three alternate names of the University where W.G. Godfrey received his BA and MA degrees?",
            "triples": [
            ...
            "answer": "B",
            "cot_answer": "According to the question and existing triples, we have established that W.G. Godfrey received his BA and MA degrees from University of Waterloo. The next step is to find the alternative names of University of Waterloo. However, none of the candidate triples provide alternate names for the University of Waterloo. The most relevant triple is B.", 
        },
        {
            "question": "What  are three alternate names of the University where W.G. Godfrey received his BA and MA degrees?",
            "triples": [
            ...
            "answer": "B",
            "cot_answer": "According to the question and existing triples, we need to find three alternate names for the University of Waterloo. However, none of the candidate triples provide alternate names for the University of Waterloo. The most relevant triple is B.", 
        },
        {
            "question": "What  are three alternate names of the University where W.G. Godfrey received his BA and MA degrees?",
            "triples": [
            ...
            "answer": "C",
            "cot_answer": "According to the question and existing triples, we need to find three alternate names for the University of Waterloo. However, none of the candidate triples provide alternate names for the University of Waterloo. The most relevant triple is C.",
        },
    ],
    [
        {
            ...
            "answer": "C",
            "cot_answer": "According to the question, we need to determine the number of bands Paul Draper and Kevin Max have performed in. So the next relevant triple is C.",
        },
        {
            "question": "Who has perofrmed in more bands, Paul Draper or Kevin Max?",
            "triples": [
            ...
            "answer": "C",
            "cot_answer": "According to the question and existing triples, we need to determine the number of bands Paul Draper and Kevin Max have performed in. So the next relevant triple is C.", 
        },
        {
            "question": "Who has perofrmed in more bands, Paul Draper or Kevin Max?",
            "triples": [
            ...
            "answer": "E",
            "cot_answer": "According to the question and existing triples, we need to determine the number of bands Paul Draper and Kevin Max have performed in. So the next relevant triple is E.", 
        },
        {
            "question": "Who has perofrmed in more bands, Paul Draper or Kevin Max?",
            "triples": [
            ...
            "answer": "A",
            "cot_answer": "According to the question and existing triples, we know that Paul Draper has performed in one band, Mansun. Kevin Max has performed in two bands: DC Talk and Audio Adrenaline. There is no more relevant information in candidate triples. So the next relevant triple is A.", 
        },
    ],
    [
        {
    ...
    [
        {
            ...
            "candidate_triples": [
                "A. no need for additional knowledge triples", 
                "B. <Justin Shenkarow; notable roles; Matthew Brock in \"Picket Fences\", Simon Holmes in \"Eerie, Indiana\", Harold Berman on \"Hey Arnold!\">",
                "C. <Justin Shenkarow; occupation; actor, voice actor, producer, writer, director>",
        ...
        },
        {
            "question": "Justin Shenkarow voices Harold Berman, a character from a television series that aired on what station?",
            "triples": [
                "<Justin Shenkarow; notable roles; Matthew Brock in \"Picket Fences\", Simon Holmes in \"Eerie, Indiana\", Harold Berman on \"Hey Arnold!\">"  
            ],
            "candidate_triples": [
                "A. no need for additional knowledge triples", 
...
reasoning_chains_hotpotqa_examplars = [
    ...
    },
    {
        ...
        "answer": "Waterloo, UW or UWaterloo", 
    },
    {
        "question": "Who has perofrmed in more bands, Paul Draper or Kevin Max?",
    ...
    {
        "question": "Justin Shenkarow voices Harold Berman, a character from a television series that aired on what station?",
        "chains": "<Justin Shenkarow; notable roles; Matthew Brock in \"Picket Fences\", Simon Holmes in \"Eerie, Indiana\", Harold Berman on \"Hey Arnold!\">, <Hey Arnold!; network; Nickelodeon>", 
        "answer": "Nickelodeon", 
    },
    {
        "question": "What is the 5th studio album released by the singer of \"A Girl's Gotta Do (What a Girl's Gotta Do)\"?",
